...
predictions_KNN <- knn(train=KNN_TraSet, test=KNN_ValSet, cl = KNN_TraLab, k = 20, prob = FALSE)
class(predictions_KNN)
class(KNN_ValLab)
```
```{r}
table(predictions_KNN,KNN_ValLab)
```

```{r}
accuracy_prediction <-sum(predictions_KNN == KNN_ValLab)/length(KNN_ValLab)
